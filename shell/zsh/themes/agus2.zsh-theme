...
MNML_OK_COLOR=${MNML_OK_COLOR:-'yellow'}
MNML_ERR_COLOR=${MNML_ERR_COLOR:-'red'}

MNML_USER_CHAR=${MNML_USER_CHAR:-'agus'}
...
[[ "${+MNML_PROMPT}" -eq 0 ]] && MNML_PROMPT=(mnml_ssh mnml_pyenv mnml_status 'mnml_cwd 2 0' mnml_keymap)
...
prompt_minimal2_help() {
  ...
  - Components on the left prompt
    MNML_PROMPT=(mnml_ssh mnml_pyenv mnml_status mnml_keymap 'mnml_cwd 2 0')
